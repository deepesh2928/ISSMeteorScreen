...
import {View, Text, StyleSheet, Platform, Dimensions, Image, FlatList, ImageBackground} from 'react-native';
...
export default class Meteor extends Component{
    ...
    getMeteors=()=>{
        axios
        .get('https://api.nasa.gov/neo/rest/v1/feed?api_key=f2OnSkf9jttYgUp9D1iuANgCLNzE5ysPRsIuIZx5')
        .then((response)=>{
